...
namespace ShopManagement.Domain.ProductAgg
{
    ...
    {
        public Product(string name, string code, string shortDescription, string description, string pictureAlt, string pictureTitle, long categoryId, string slug, string keywords, string metaDescription , string picture)
        {
            Name = name;
            Code = code;
